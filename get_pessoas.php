        ...
        while($registro = mysqli_fetch_array($resultado_id, MYSQLI_ASSOC)){
            ...
            echo '<a href="#" class="list-group-item">';
                ...
                echo '<p class="list-group-item-text pull-right">';
                    ...
                    echo '<button type="button" style="display: '.$btn_seguir_display.'" id="btn_seguir_'.$registro['id'].'"  class="btn btn-primary btn_seguir" data-id_usuario="'.$registro['id'].'">Seguir</button>';
